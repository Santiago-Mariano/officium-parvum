...
\startParallel
\latin{\rubrics{Ant.} Dum esset Rex in accúbitu suo, nardus mea dedit odórem suavitátis.}
\vern{\rubrics{Ant.} Mientras el rey reposaba en su lecho, mi nardo exhaló su aroma.}
\stopParallel
...
\vern{Oráculo del Señor a mi Señor: «Siéntate a mi derecha,}
\stopParallel
...
\startParallel
\latin{\rubrics{Ant.} Læva eius sub cápite meo, et déxtera illíus amplexábitur me.}
\vern{\rubrics{Ant.} Su izquierda bajo mi cabeza y su derecha me abraza.}
\stopParallel
...
\startParallel
\latin{Laudáte, púeri, Dóminum: laudáte nomen Dómini.}
\vern{Alabad, siervos del Señor, alabad el nombre del Señor.}
\stopParallel
...
\startParallel
\latin{\rubrics{Ant.} Nigra sum, sed formósa, fíliæ Ierúsalem; ídeo diléxit me Rex, et introdúxit me in cubículum suum.}
\vern{\rubrics{Ant.} Morena soy, pero hermosa, hijas de Jerusalén. Por esto el rey me ha amado y me ha introducido en su morada.}
\stopParallel
...
\startParallel
\latin{Lætátus sum in his, quæ dicta sunt mihi: In domum Dómini íbimus.}
\vern{¡Qué alegría cuando me dijeron: «Vamos a la casa del Señor»!}
\stopParallel
...
\startParallel
\latin{\rubrics{Ant.} Iam hiems tránsiit, imber ábiit et recéssit: surge, amíca mea, et veni.}
\vern{\rubrics{Ant.} Ya ha pasado el invierno y han cesado las lluvias: levántate, amiga mía, y ven.}
\stopParallel
...
\startParallel
\latin{Nisi Dóminus ædificáverit domum, in vanum laboravérunt qui ædíficant eam.}
\vern{Si el Señor no construye la casa, en vano se cansan los albañiles;}
\stopParallel
...
\startParallel
\latin{\rubrics{Ant.} Speciósa facta es et suávis in delíciis tuis, sancta Dei Génetrix.}
\vern{\rubrics{Ant.} Eres hermosa y buena, y llena de gracia, Santa Madre de Dios.}
\stopParallel
...
\startParallel
\latin{Lauda, Ierúsalem, Dóminum: lauda Deum tuum, Sion.}
\vern{Glorifica al Señor, Jerusalén; alaba a tu Dios, Sión:}
\stopParallel
...
\startParallel
\latin{\rubrics{Ant.} Missus est Gábriel Angelus ad Maríam Vírginem desponsátam Ioseph.}
\vern{\rubrics{Ant.} El ángel Gabriel fue enviado por Dios a la Virgen María, desposada con José.}
\stopParallel
...
\startParallel
\latin{\rubrics{Ant.} Ave, María, grátia plena; Dóminus tecum: benedícta tu in muliéribus.}
\vern{\rubrics{Ant.} Alégrate, María, llena de gracia, el Señor está contigo: bendita Tú entre las mujeres.}
\stopParallel
...
\startParallel
\latin{\rubrics{Ant.} Ne tímeas, María, invenísti grátiam apud Dóminum: ecce concípies et páries fílium.}
\vern{\rubrics{Ant.} No temas, María, porque has encontrado gracia ante Dios. Concebirás en tu vientre y darás a luz un hijo.}
\stopParallel
...
\startParallel
\latin{\rubrics{Ant.} Dabit ei Dóminus sedem David, patris eius, et regnábit in ætérnum.}
\vern{\rubrics{Ant.} El Señor le dará el trono de David, su padre, y reinará para siempre.}
\stopParallel
...
\startParallel
\latin{\rubrics{Ant.} Ecce ancílla Dómini: fiat mihi secúndum verbum tuum.}
\vern{\rubrics{Ant.} Aquí está la esclava del Señor, hágase en mí según tu palabra.}
\stopParallel
...
\startParallel
\latin{\rubrics{Ant.} O admirábile commércium: Creátor géneris humáni, animátum corpus sumens, de Vírgine nasci dignátus est; et procédens homo sine sémine, largítus est nobis suam Deitátem.}
\vern{\rubrics{Ant.} ¡Qué admirable cambio! El Creador del género humano, tomando un cuerpo vivo, se ha dignado nacer de una Virgen, y haciéndose hombre sin concurso de varón, nos ha regalado su divinidad.}
\stopParallel
...
\startParallel
\latin{\rubrics{Ant.} Quando natus es ineffabíliter ex Vírgine, tunc implétæ sunt Scriptúræ: sicut plúvia in vellus descendísti, ut salvum fáceres genus humánum: te laudámus, Deus noster.}
\vern{\rubrics{Ant.} Cuando inefablemente naciste de la Virgen, se cumplieron las Escrituras. Descendiste como lluvia sobre el vellón, para salvar a los hombres. Te alabamos, Dios nuestro.}
\stopParallel
...
\startParallel
\latin{\rubrics{Ant.} Rubum, quem víderat Móyses incombústum, conservátam agnóvimus tuam laudábilem virginitátem: Dei Génetrix, intercéde pro nobis.}
\vern{\rubrics{Ant.} En la zarza que Moisés vio arder sin consumirse, reconocemos tu virginidad milagrosamente conservada. Madre de Dios, intercede por nosotros.}
\stopParallel
...
\startParallel
\latin{\rubrics{Ant.} Germinávit radix Iesse, orta est stella ex Iacob: Virgo péperit Salvatórem; te laudámus, Deus noster.}
\vern{\rubrics{Ant.} Ha brotado un renuevo del tronco de Jesé. Una estrella ha nacido en la casa de Jacob. Una Virgen ha dado a luz al Salvador. Te alabamos, Dios nuestro.}
\stopParallel
...
\startParallel
\latin{\rubrics{Ant.} Ecce María génuit nobis Salvatórem, quem Ioánnes videns, exclamávit, dicens: Ecce Agnus Dei, ecce qui tollit peccáta mundi, allelúia.}
\vern{\rubrics{Ant.} María ha dado a luz al Salvador. Juan dijo al verle: Éste es el Cordero de Dios, que quita el pecado del mundo. Aleluya.}
\stopParallel
...
\startParallel
\latin{\rubrics{A}b inítio et ante sǽcula creáta sum, et usque ad futúrum sǽculum non désinam, et in habitatióne sancta coram ipso ministrávi.}
\vern{\rubrics{D}esde el principio fui creada, antes de los siglos, y por los siglos duraré. En la santa morada, en su presencia ofrecí el culto.}
\latin{\response Deo grátias.}
\vern{\response Demos gracias a Dios.}
\stopParallel
...
\startParallel
\latin{\rubrics{E}grediétur virga de radíce Iesse, et flos de radíce eius ascéndet. Et requiéscet super eum Spíritus Dómini.}
\vern{\rubrics{B}rotará un renuevo del tronco de Jesé, un vástago florecerá de su raíz. Sobre él se posará el Espíritu del Señor.}
\latin{\response Deo grátias.}
\vern{\response Demos gracias a Dios.}
\stopParallel
...
\chapter{Himno: Ave Maris Stella}
...
\chapter{Magnificat}
\section{Durante el Año}

\startParallel
\latin{\rubrics{Ant.} Beáta Mater et intácta Virgo, gloriósa Regína mundi, intercéde pro nobis ad Dóminum.}
\vern{\rubrics{Ant.} Bienaventurada Madre y Virgen intacta, gloriosa reina del mundo, intercede al Señor por nosotros.}
\stopParallel
